...
export const TO_SCHOOL_SCHEDULE: ShuttleTime[] = [
  { hour: 7, minute: 56, type: 'to_school', trainTime: '07:46' },
  { hour: 8, minute: 35, type: 'to_school', trainTime: '08:25', isExpress: true },
  { hour: 8, minute: 55, type: 'to_school', trainTime: '08:45' },
  { hour: 9, minute: 45, type: 'to_school', trainTime: '09:35' },
  { hour: 10, minute: 6, type: 'to_school', trainTime: '09:56' },
  { hour: 10, minute: 27, type: 'to_school', trainTime: '10:17' },
  { hour: 10, minute: 53, type: 'to_school', trainTime: '10:43' },
  { hour: 11, minute: 17, type: 'to_school', trainTime: '11:07' },
  { hour: 11, minute: 47, type: 'to_school', trainTime: '11:37' },
  { hour: 12, minute: 2, type: 'to_school', trainTime: '11:52' },
  { hour: 12, minute: 33, type: 'to_school', trainTime: '12:23' },
  { hour: 13, minute: 2, type: 'to_school', trainTime: '12:52' },
  { hour: 13, minute: 24, type: 'to_school', trainTime: '13:14', isExpress: true },
  { hour: 13, minute: 55, type: 'to_school', trainTime: '13:45' },
  { hour: 14, minute: 3, type: 'to_school', trainTime: '13:53', isExpress: true },
  { hour: 14, minute: 31, type: 'to_school', trainTime: '14:21' },
  { hour: 15, minute: 4, type: 'to_school', trainTime: '14:54' },
  { hour: 15, minute: 33, type: 'to_school', trainTime: '15:23', isExpress: true },
  { hour: 16, minute: 21, type: 'to_school', trainTime: '16:11' },
  { hour: 16, minute: 40, type: 'to_school', trainTime: '16:30', isExpress: true },
  { hour: 17, minute: 23, type: 'to_school', trainTime: '17:13' },
  { hour: 18, minute: 7, type: 'to_school', trainTime: '17:57' },
  { hour: 18, minute: 20, type: 'to_school', trainTime: '18:10' },
  { hour: 18, minute: 53, type: 'to_school', trainTime: '18:43', isExpress: true },
  { hour: 19, minute: 15, type: 'to_school', trainTime: '19:05' },
  { hour: 19, minute: 32, type: 'to_school', trainTime: '19:22', isExpress: true },
  { hour: 19, minute: 53, type: 'to_school', trainTime: '19:43', isExpress: true },
  { hour: 20, minute: 23, type: 'to_school', trainTime: '20:13' },
  { hour: 20, minute: 58, type: 'to_school', trainTime: '20:48' },
  { hour: 21, minute: 16, type: 'to_school', trainTime: '21:06' },
  { hour: 21, minute: 44, type: 'to_school', trainTime: '21:34' },
  { hour: 21, minute: 57, type: 'to_school', trainTime: '21:47' },
];
